...
This surface owns command routing, read/forecast/hygiene modes, portfolio output shape, and read-only policy. Hygiene remains Salesforce-only. `pipeline-read` makes no writes.
