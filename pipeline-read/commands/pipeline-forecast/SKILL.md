...
**pipeline-read** repo; this command runs that pipeline in **forecast** mode and presents the
forecast-read view.
...
`--amount-basis acv|crm-primary-amount`; `--compare <prior-computed-inputs.json>`;
