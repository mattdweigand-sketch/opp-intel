...
def account_history(prior_opps):
    ...
    lost = [o for o in prior_opps if o.get("StageName") == "Lost"]
    won = [o for o in prior_opps if o.get("IsWon") is True or o.get("StageName") == "Won"]
...
def main():
    ...
    if internal_evidence:
        out["internal_evidence"] = internal_evidence
